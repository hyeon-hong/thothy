...
patch_builder.add_conditional_edges(
    "extract_patch_memories", should_commit_patch)
...
semantic_builder.add_conditional_edges(
    "extract_semantic_memories", should_insert)
