        ...
        parameters: [
            {
                name: "size",
                description:
                    "The font size to set (e.g., '14px', '16px', '18px').",
                type: "string",
                required: true,
            },
        ],
        ...
        >
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="bg-gradient-to-r from-blue-500 to-purple-500 p-8 rounded-2xl shadow-2xl mb-8">
                        ...
                        <p className="text-white text-center text-lg opacity-90">
                            Your AI-powered assistant is ready to help. Try
                            asking me to:
                        </p>
                    ...
                    >
                        <p className="text-center" style={{ fontSize }}>
                            Start a conversation with the AI assistant using the
            ...
            <CopilotChat
                labels={{
                    title: "AI Assistant",
                    initial:
                        "Hi! I'm your AI assistant. I can help you customize the page and interact with various features. Try asking me to change the theme, adjust colors, or greet you!",
                }}
