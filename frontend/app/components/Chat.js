...
export function Chat({ inputRef, graph_name }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Call sendMessage with the input and graph_name
            sendMessage(
                currentThreadId,
                {
                    text: messageText,
        ...
        <div className="flex h-[calc(100vh-64px)] bg-gray-50">
            ...
            <div className="flex flex-1 overflow-hidden">
                ...
                <div className="flex-1 flex flex-col relative">
                    ...
                    {/* Messages area - fills remaining space but stops events from propagating up */}
                    <div
                        className="flex-1 overflow-y-auto p-4 space-y-4"
                        style={{ paddingBottom: `${INPUT_HEIGHT + 16}px` }}
                        onClick={(e) => {
                            // Only stop propagation for clicks inside the messages area
                            e.stopPropagation();
                        }}
                    >
