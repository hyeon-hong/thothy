...
from ui_eval_graph.prompts import get_coding_prompt
from ui_eval_graph.tools import analyze_ui
...
UI_COMPONENT_NAME = "ui_eval_graph"
...
tool_node = ToolNode([analyze_ui])

model = get_llm()
model_with_tools = model.bind_tools([analyze_ui],
                                    tool_choice="any",
                                    strict=True)
...
def call_model(state: AgentState):
    ...
    score, analysis = extract_artifact_from_response(response)
