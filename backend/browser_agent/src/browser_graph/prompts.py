...
4) If you feel to need more information, you can crawl the current webpage.
5) Don't repeat the same action as before.

* Web Browsing Guidelines *
1) Don't interact with useless web elements like Login, Sign-in, donation that appear in Webpages
2) Select strategically to minimize time wasted.
3) If you need to crawl the current webpage, use the Crawl action.
